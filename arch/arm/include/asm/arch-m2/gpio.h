...
#define GPIOX_bank_bit0(bit)        (PREG_JTAG_GPIO)
#define GPIOX_bit_bit0_mode(bit)    (16)
#define GPIOX_bit_bit0_out(bit)     (20)
#define GPIOX_bit_bit0_in(bit)      (24)

#define GPIOX_bank_bit1_31(bit)     (PREG_EGPIO)
#define GPIOX_bit_bit1_31(bit)      (bit)

#define GPIOX_bank_bit32_63(bit)    (PREG_FGPIO)
#define GPIOX_bit_bit32_63(bit)     (bit-32)

#define GPIOX_bank_bit64_70(bit)    (PREG_GGPIO)
#define GPIOX_bit_bit64_70(bit)     (bit-64)

#define GPIOB_bank_bit0_8(bit)      (PREG_GGPIO)
#define GPIOB_bit_bit0_8(bit)       (bit+8)

#define GPIOD_bank_bit0_6(bit)      (PREG_GGPIO)
#define GPIOD_bit_bit0_6(bit)       (bit+24)
