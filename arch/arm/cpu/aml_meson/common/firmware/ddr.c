...
static void init_pctl(struct ddr_set * ddr_setting)
{
    ...
    serial_puts("IOCR=");
//    serial_put_dword(APB_Rd(PCTL_IOCR_ADDR) );
...
//	APB_Wr(PCTL_ZQCR_ADDR,   (1 << 24) | 0x33dd);
	APB_Wr(PCTL_ZQCR_ADDR,   (1 << 24) | 0x1166); //default for 2pcs ddr
//	APB_Wr(PCTL_ZQCR_ADDR,   (1 << 24) | 0x1155);
//	APB_Wr(PCTL_ZQCR_ADDR,   (1 << 24) | 0x11dd); //default for 4pcs ddr
