...
#if (defined CONFIG_BOARD_MBOX_8626M1) || (defined CONFIG_BOARD_GADMEI_6236M) || (defined CONFIG_BOARD_DVBC_8726M1)
...
#if (defined CONFIG_BOARD_MBOX_8626M1) || (defined CONFIG_BOARD_DVBC_8726M1)
