...
static const reg_t tvregs_480i[] = {
    {HHI_VIID_CLK_DIV,             0x11100101,},
    {HHI_VID_CLK_DIV,              0x11110003,},
    {VENC_VDAC_SETTING,            0xff,  },
    {ENCP_VIDEO_EN,              0,     },
    {ENCI_VIDEO_EN,              0,     },
...
static const reg_t tvregs_480cvbs[] = {
    {HHI_VIID_PLL_CNTL,             0x20224,    },
    {HHI_VIID_DIVIDER_CNTL,         0x18803,    },
    {HHI_VIID_CLK_CNTL,             0xc001f,    },
    {HHI_VIID_CLK_DIV,              0x99110103  },
    {HHI_VID_CLK_DIV,               0x91110003  },
    {VENC_VDAC_SETTING,            0xff,  },
    {ENCP_VIDEO_EN,              0,     },
    {ENCI_VIDEO_EN,              0,     },
...
//	{VCLK_HD},
    ...
    {VPU_VIU_VENC_MUX_CTRL,      0x000a,},      //New Add. If not set, when system boots up, switch panel to HDMI 1080I, nothing on TV.
    {VENC_VIDEO_PROG_MODE,       0x100, },
