...
//#define SECURE_CMD_UPDATE_AUTH_RA  ??
/**********************************************************************************/
/**********************************************************************************/
/* function: get CI raw data
/* secure_runtime_call(NULL, 0, pOUT, pOUTLen, -1, SECURE_CMD_GAIN_CI) */
...
/**********************************************************************************/
/* function: burn MAC raw data
/* secure_runtime_call(pSRC, 6, NULL, NULL, -1, SECURE_CMD_BURN_MAC) */
/* return 0:free 1: has written  */
/* pSRC data must be little-endian */
/**********************************************************************************/

/**********************************************************************************/
/* function: get MAC raw data
/* secure_runtime_call(NULL, 0, pOUT, pOUTLen, -1, SECURE_CMD_GAIN_MAC) */
/* return 0:free 1: has written  */
/* pSRC data must be little-endian */
/**********************************************************************************/

/**********************************************************************************/
/* function: burn SN raw data
/* secure_runtime_call(pSRC, 24, NULL, NULL, -1, SECURE_CMD_BURN_SN_RAW) */
/* return 0:free 1: has written  */
/* pSRC data must be little-endian */
/**********************************************************************************/

/**********************************************************************************/
/* function: burn IN raw data
/* secure_runtime_call(pSRC, 24, NULL, NULL, -1, SECURE_CMD_BURN_IN_RAW) */
/* return 0:free 1: has written  */
/* pSRC data must be little-endian */
/**********************************************************************************/

/**********************************************************************************/
/* function: RSA decrypt via secure key
/* secure_runtime_call(NULL, 0, NULL, NULL, -1, SECURE_CMD_CHECK_IN_FREE) */
/* return 0:free 1: has written  */
/**********************************************************************************/
...
/**********************************************************************************/
/* function: RSA decrypt via secure key
/* secure_runtime_call(pSRC, nDataLen, pOUT, pOUTLen, procedure, SECURE_CMD_RSA_DEC_VIA_SECU_KEY) */
/* return 0:ok 1:fail  */
/* nDataLen must be 128 */
/* procedure: if input/output string no big/little ending issue, choose: RSA_BUF_IN_TYPE_IGNORE/RSA_BUF_OUT_TYPE_IGNORE
/**********************************************************************************/
