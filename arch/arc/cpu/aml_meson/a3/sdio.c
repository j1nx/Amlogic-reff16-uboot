...
void  cpu_sdio_pwr_prepare(unsigned port)
{
    ...
    switch(port)
    {
        ...
        case SDIO_PORT_B://SDIOB,GPIOA_0~GPIOA_5
            clrbits_le32(P_PERIPHS_PIN_MUX_0,0x3f<<20);
            ///@todo pull down these bits
            break;
        case SDIO_PORT_C://SDIOC GPIOB_2~GPIOB_7
            //set sdio C pinmux
            clrbits_le32(P_PERIPHS_PIN_MUX_4,0x3f<<22);
            ///@todo pull down these bits
            break;
        case SDIO_PORT_C1://SDIOB1 GPIOE_6~GPIOE_11
            // disable SPI and SDIO_B
            clrbits_le32(P_PERIPHS_PIN_MUX_3,( 0x3f<<26));
...
int cpu_sdio_init(unsigned port)
{
    switch(port)
    {
        ...
        case SDIO_PORT_C1://SDIOB1 GPIOE_6~GPIOE_11
            // disable SPI and SDIO_B
            setbits_le32(P_PERIPHS_PIN_MUX_3,( 0x3f<<26));
