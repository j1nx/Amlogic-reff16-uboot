...
void bitblt(int ge2d_handle,
            int src_x, int src_y, int w, int h,
            int dst_x, int dst_y);

void bitblt_noblk(int ge2d_handle,
            int src_x, int src_y, int w, int h,
            int dst_x, int dst_y);

void bitblt_noalpha(int ge2d_handle,
                    int src_x, int src_y, int w, int h,
                    int dst_x, int dst_y);

void bitblt_noalpha_noblk(int ge2d_handle,
                    int src_x, int src_y, int w, int h,
                    int dst_x, int dst_y);

void stretchblt(int ge2d_handle,
                int src_x, int src_y, int src_w, int src_h,
                int dst_x, int dst_y, int dst_w, int dst_h);

void stretchblt_noblk(int ge2d_handle,
                int src_x, int src_y, int src_w, int src_h,
                int dst_x, int dst_y, int dst_w, int dst_h);

void stretchblt_noalpha(int ge2d_handle,
                        int src_x, int src_y, int src_w, int src_h,
                        int dst_x, int dst_y, int dst_w, int dst_h);

void stretchblt_noalpha_noblk(int ge2d_handle,
                        int src_x, int src_y, int src_w, int src_h,
                        int dst_x, int dst_y, int dst_w, int dst_h);

void fillrect(int ge2d_handle,
              int x, int y, int w, int h, unsigned color);

void fillrect_noblk(int ge2d_handle,
              int x, int y, int w, int h, unsigned color);
...
void blend(int ge2d_handle,
           int src_x, int src_y, int src_w, int src_h, 
           int src2_x, int src2_y, int src2_w, int src2_h,
           int dst_x, int dst_y, int dst_w, int dst_h,
           int op);

void blend_noblk(int ge2d_handle,
           int src_x, int src_y, int src_w, int src_h, 
           int src2_x, int src2_y, int src2_w, int src2_h,
           int dst_x, int dst_y, int dst_w, int dst_h,
           int op);
