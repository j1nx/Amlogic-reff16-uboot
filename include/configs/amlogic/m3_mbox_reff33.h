...
#define CONFIG_EXTRA_ENV_SETTINGS \
	...
	"bootargs=androidboot.resolution=720p rootwait init=/init console=ttyS0,115200n8 nohlt  a9_clk=600M clk81=187000000 mem=512m\0" \
    "nandargs=setenv bootargs androidboot.resolution=${outputmode} rootwait init=/init console=${console} nohlt logo=osd1,0x84100000,loaded,${outputmode} a9_clk=600M clk81=187000000 mem=512m quiet mac=${ethaddr} hdmitx=${outputmode},true\0"\
    "recoveryargs=setenv bootargs console=${console} nohlt a9_clk=600M clk81=187000000 mem=512m quiet mac=${ethaddr}\0"\
...
#ifdef CONFIG_UCL
	#define CONFIG_ENV_OFFSET           0x7e000//0x3e000
#else
	#define CONFIG_ENV_OFFSET           0x1f0000
#endif
        //#define CONFIG_MAC_OFFSET           0x7d000
