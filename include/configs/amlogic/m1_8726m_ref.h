...
#define CONFIG_BOOTCOMMAND  "nand read ${normal_name} ${loadaddr} 0 ${normalsize};bootm"
...
#ifdef CONFIG_UCL
	#define CONFIG_ENV_OFFSET           0x3e000		//Notice: u-boot-aml-ucl.bin <= 0x3e000(253952Byte)
#else
