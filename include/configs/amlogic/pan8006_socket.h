...
#define CONFIG_EXTRA_ENV_SETTINGS \
	...
	"chipname=8726m\0" \
	"machid=2956\0" \
	"bootargs=init=/init console=ttyS1,115200"  BOARD_INFO_ENV  " board_ver=v2 clk81=187500k hdmitx=vdacoff,powermode1,unplug_powerdown rootwait logo=osd1,0x84100000,lcd,full\0" \
	"partnum=4\0" \
	"p0start=0x2000000\0" \
	"p0size=0x800000\0" \
	"p0path=logo\0" \
