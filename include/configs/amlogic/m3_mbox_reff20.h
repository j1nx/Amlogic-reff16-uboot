...
#define CONFIG_MEMSIZE  1024     //unit is MB
...
#define MTDPARTS_DEFAULT	"mtdparts=nandflash1:640m@764m(rs_data)\0"	//xxxm@yyym,xxx-size,yyy-offset
#endif

#define CONFIG_CMD_AUTOSCRIPT
#define CONFIG_AML_AUTOSCRIPT
#define AML_AUTOSCRIPT  "bestv_autoscript"
...
#define DEFAULT_FONT &ISO_88591_40Font
#endif
...
#define CONFIG_EXTRA_ENV_SETTINGS \
	...
	"bootargs=root=/dev/cardblksd2 rw rootfstype=ext3 androidboot.resolution=720p rootwait init=/init console=ttyS0,115200n8 nohlt  a9_clk=600M clk81=187500000 mem=1024m mac=${ethaddr} facid=${facid} hwid=${hwid} quiet\0" \
    "nandargs=setenv bootargs rootfstype=ext3 androidboot.resolution=${outputmode} rootwait init=/init console=ttyS0,115200n8 nohlt logo=osd1,0x84100000,loaded,${outputmode} a9_clk=600M clk81=187500000 mem=1024m mac=${ethaddr} facid=${facid} hwid=${hwid} quiet\0"\
    "nandboot=run nandargs; nand read ${normal_name} ${loadaddr} 0 ${normal_size};bootm ${loadaddr};osd fill 0;drawstr ERR:0010 600 350 ff0000; \0"\
    ...
    "bootloader_path=u-boot-bestv.bin\0" \
    "normal_name=boot\0" \
