 ...
 *
 */
//#define CONFIG_AMLENV_NO_NAND /*This is for no nand flash on board. Special case.*/
...
#define CONFIG_SYS_CLK      600 /*600Mhz  a9 clk@todo redefine it later
                                 */
#define CONFIG_CRYSTAL_MHZ		24  /* The CRYSTAL of AV800C-A3-DDR3-SOCKET V1.0 is 24MHz*/
...
#define CONFIG_AML_LOGO        1
#define CONFIG_CMD_TV          1
#define CONFIG_CMD_OSD         1
#define CONFIG_CMD_BMP         1
#define CONFIG_ARCH_AMLOGIC_APOLLO_A3
...
#define CONFIG_SERIAL_HWUART	1	/* Use the Hardware serial as the debug UART*/
