...
#define CONFIG_MEMSIZE  256//512     //unit is MB
...
#define CONFIG_EXTRA_ENV_SETTINGS \
	...
	"bootargs=init=/init console=ttyS0,115200" \
	" board_ver=v2 clk81=187500k hdmitx=vdacoff,powermode1,unplug_powerdown rootwait logo=osd1,0x84100000,lcd,full\0" \
...
#define CONFIG_EXTRA_ENV_SETTINGS \
    ...
    " mem=${memsize} a9_clk=${cpuclock} clk81=${gpuclock}" \
	" logo=osd1,${loadlogoaddr},full,${outputmode},loaded androidboot.resolution=${outputmode}" \
    	" resolution_size=${screen_width},${screen_height}\0" \
