...
#define CONFIG_EXTRA_ENV_SETTINGS \
	...
	"boardname=lenovo_mbox_f16\0" \
	"chipname=8726m\0" \
	"bootargs=root=/dev/cardblksd2 rw rootfstype=ext3 rootwait init=/init console=ttyS0,115200n8 nohlt a9_clk=600M clk81=200M mem=512m\0" \
    "nandboot=nand read ${logo_name} 84100000 0 ${logo_size};nand read ${normal_name} ${loadaddr} 0 ${normal_size};bootm ${loadaddr}\0"\
...
/* Monitor at start of flash */
	...
	#define UBOOTPATH		"u-boot-aml-ucl.bin"
#else
