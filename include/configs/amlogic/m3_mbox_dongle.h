...
#define CONFIG_USB_DEVICE	//cvt
#define CONFIG_USBPORT_BASE IO_USB_A_BASE	//cvt
#if 0
...
#define CONFIG_AML_TINY_USBTOOL	//cvt
...
#define CONFIG_EXTRA_ENV_SETTINGS \
	...
	"boardname=m3_mbox_dongle\0" \
	"chipname=8726m\0" \
	"outputmode=720p\0" \
	"720poutputwidth=1280\0"\
    "720poutputheight=720\0"\
	"bootargs=root=/dev/cardblksd2 rw rootfstype=ext3 androidboot.resolution=720p rootwait init=/init console=ttyS0,115200n8 nohlt  a9_clk=600M clk81=187500000 mem=1024m \0" \
    "nandargs=setenv bootargs rootfstype=ext3 androidboot.resolution=${outputmode} rootwait init=/init console=ttyS0,115200n8 nohlt logo=osd1,0x84100000,loaded,${outputmode} hdmitx=unplug_powerdown,vdacoff a9_clk=600M clk81=187500000 mem=1024m\0"\
