...
#define FB_ADDR     0x84a00000
#define OSD_WIDTH   1366
#define OSD_HEIGHT  768
#define OSD_BPP     OSD_COLOR24
#define CONFIG_AML_LVDS_1366x768
...
#define AML_AUTOSCRIPT  "aml_autoscript_e08_4pc_4l"
...
#define CONFIG_EXTRA_ENV_SETTINGS \
    ...
    "jeida=1\0" \
    "version=1\0" \
    "bootargs=mem=512M a9_clk=600M clk81=187500k mac=00:01:22:65:04:88 console=ttyS0,115200n8 lvds=8bit,jeida board_ver=v2 logo=lvds1080p,loaded,osd1\0" \
    "nandargs=nand info;setenv bootargs mem=${memsize} a9_clk=${cpuclock} clk81=${gpuclock} lvds=8bit,jeida mac=${ethaddr} console=${console} board_ver=v2 logo=lvds1080p,loaded,osd1\0" \
...
#define DDR3_7_7_7
    ...
    //board/amlogic/aml_tv_m2c_haier/firmware/timming.c 
    
    //note: please DO NOT remove following check code
#if !defined(DDR3_9_9_9) && !defined(DDR3_7_7_7)
	#error "Please set DDR3 property first in file aml_tv_m2c_refe08.h\n"
#endif
...
#define M2C_DDR3_512M
	...
	#error "Please set DDR3 capacity first in file aml_tv_m2c_refe08.h\n"
#endif
...
#else
	#error "Please define DDR3 memory capacity in file aml_tv_m2c_refe08.h\n"
#endif
