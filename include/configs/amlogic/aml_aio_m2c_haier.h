...
#define AML_AUTOSCRIPT  "aml_autoscript_e05"
...
#define CONFIG_EXTRA_ENV_SETTINGS \
    ...
    "version=1\0" \
    "port_reverse=1\0"\
    "bootargs=mem=512M a9_clk=600M clk81=187500k mac=00:01:22:65:04:88 lvds=8bit,port_reverse console=ttyS0,115200n8, logo=lvds1080p,loaded,osd1\0" \
    "nandargs=nand info;setenv bootargs mem=${memsize} a9_clk=${cpuclock} clk81=${gpuclock} mac=${ethaddr}  lvds=8bit,port_reverse console=${console}  logo=lvds1080p,loaded,osd1\0" \
...
#define DDR3_7_7_7
    ...
    //board/amlogic/aml_aio_m2c_haier/firmware/timming.c 
    
    //note: please DO NOT remove following check code
#if !defined(DDR3_9_9_9) && !defined(DDR3_7_7_7)
	#error "Please set DDR3 property first in file aml_aio_m2c_haier.h\n"
#endif
...
#define M2C_DDR3_512M
	...
	#error "Please set DDR3 capacity first in file aml_aio_m2c_haier.h\n"
#endif
...
#else
	#error "Please define DDR3 memory capacity in file aml_aio_m2c_haier.h\n"
#endif
