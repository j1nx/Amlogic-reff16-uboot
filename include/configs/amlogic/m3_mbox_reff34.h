...
#define AML_AUTOSCRIPT  "gntv_autoscript"
...
#define CONFIG_M3_USBPORTA_BASE	0xC9040000
#define CONFIG_M3_USBPORTB_BASE	0xC90C0000
...
#define CONFIG_EXTRA_ENV_SETTINGS \
	...
	"boardver=v1\0"\
	"clk81=187000000\0"\
	"bootargs=hdmitx=720p,true androidboot.resolution=720p console=ttyS0,115200n8 nohlt boardver=v1 a9_clk=600M clk81=187000000 mem=1024m\0" \
    "nandargs=setenv bootargs hdmitx=${outputmode},true androidboot.resolution=${outputmode} console=${console} nohlt boardver=${boardver} logo=osd1,0x84100000,loaded,${outputmode} mac=${ethaddr} a9_clk=600M clk81=${clk81} mem=1024m quiet\0"\
    "nandboot=run nandargs; nand read ${normal_name} ${loadaddr} 0 ${normal_size};bootm ${loadaddr}\0"\
    "recoveryboot=run recoveryargs; nand read ${recovery_name} ${loadaddr} 0 ${recovery_size};bootm ${loadaddr}\0"\
    "recoveryargs=setenv bootargs console=${console} nohlt boardver=${boardver} a9_clk=600M clk81=${clk81} mem=1024m quiet\0"\
    "nandboot=run nandargs; nand read ${normal_name} ${loadaddr} 0 ${normal_size};bootm ${loadaddr}\0"\
...
#endif
	#define WRITE_DEFAULT_ENV_IN_SPI
