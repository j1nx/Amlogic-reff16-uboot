...
#define CONFIG_EXTRA_ENV_SETTINGS \
    ...
    "cpuclock=600M\0" \
    "bootargs=mem=512M a9_clk=600M clk81=187500k mac=00:01:22:65:04:88 console=ttyS0,115200n8, logo=lvds1080p,loaded,osd1\0" \
    "nandargs=nand info;setenv bootargs mem=${memsize} a9_clk=${cpuclock} clk81=${gpuclock} mac=${ethaddr}  console=${console}  logo=lvds1080p,loaded,osd1\0" \
...
#define DDR3_7_7_7
    ...
    //board/amlogic/aml_tv_m2c_2pc_4l_refe07/firmware/timming.c 
    
    //note: please DO NOT remove following check code
#if !defined(DDR3_9_9_9) && !defined(DDR3_7_7_7)
	#error "Please set DDR3 property first in file aml_tv_m2c_2pc_4l_refe07.h\n"
#endif
...
#define M2C_DDR3_512M
	...
	#error "Please set DDR3 capacity first in file aml_tv_m2c_2pc_4l_refe07.h\n"
#endif
...
#else
	#error "Please define DDR3 memory capacity in file aml_tv_m2c_2pc_4l_refe07.h\n"
#endif
