...
#define AML_AUTOSCRIPT  "aml_autoscript_e04_2pc_2l"
...
#define CONFIG_EXTRA_ENV_SETTINGS \
    ...
    "nandargs=nand info;setenv bootargs mem=${memsize} a9_clk=${cpuclock} clk81=${gpuclock} lpj=5980160 mac=${ethaddr} console=${console} board_ver=v2 logo=lvds1080p,loaded,osd1\0" \
...
#define DDR3_7_7_7
	...
	#error "Please set DDR3 property first in file aml_tv_m2c_haier.h\n"
#endif
...
#define M2C_DDR3_512M
	...
	#error "Please set DDR3 capacity first in file aml_tv_m2c_haier.h\n"
#endif
...
#else
	#error "Please define DDR3 memory capacity in file aml_tv_m2c_haier.h\n"
#endif
