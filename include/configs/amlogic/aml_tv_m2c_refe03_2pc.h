...
#define CONFIG_COLD_HEART_KEY 0xb9467d02
#define AML_REF_IR
#endif
...
//#define SMALL_SCREEN_SIZE 1
#define TSD_SUPPORT 1

#ifdef SMALL_SCREEN_SIZE
#define CONFIG_EXTRA_ENV_SETTINGS \
    ...
    "logoaddr=800000\0" \
    "logosize=800000\0" \
    "recoveryboot=run recoveryargs; nandinfo; nand read ${loadaddr} 1000000 800000; bootm ${loadaddr}\0" \
    "emmcrecoveryboot=run recoveryargs; mmc read 0 ${loadaddr} 1000000 800000; bootm ${loadaddr}\0" \
    "recoveryargs=setenv bootargs mem=${memsize} recoverymode=${recoverymode} console=${console} board_ver=v2 logo=lvds1080p,loaded,osd1\0" \
    "nandboot=echo Booting from nand ...; run nandargs; nandinfp; nand read ${loadaddr} 1800000 800000; bootm ${loadaddr}\0" \
    "emmcboot=echo Booting from emmc ...; run nandargs; mmc read 0 ${loadaddr} 1800000 800000; bootm ${loadaddr}\0" \
    ...
    "nandargs=setenv bootargs mem=${memsize} a9_clk=${cpuclock} clk81=${gpuclock} mac=${ethaddr} board_ver=v2 logo=lvds1080p,loaded,osd1\0" \
    "factory_standby=1\0" \
    "port_reverse=1\0" \
    "768p=1"
#else
#define CONFIG_EXTRA_ENV_SETTINGS \
    ...
    "logoaddr=800000\0" \
    "logosize=800000\0" \
    "recoveryboot=run recoveryargs; nand info; nand read ${loadaddr} 1000000 800000; bootm ${loadaddr}\0" \
    "emmcrecoveryboot=run recoveryargs; mmc read 0 ${loadaddr} 1000000 800000; bootm ${loadaddr}\0" \
    "recoveryargs=setenv bootargs mem=${memsize} recoverymode=${recoverymode} console=${console} board_ver=v2 logo=lvds1080p,loaded,osd1\0" \
    "nandboot=echo Booting from nand ...; run nandargs; nand info; nand read ${loadaddr} 1800000 800000; bootm ${loadaddr}\0" \
    "emmcboot=echo Booting from emmc ...; run nandargs; mmc read 0 ${loadaddr} 1800000 800000; bootm ${loadaddr}\0" \
    "console=ttyS0,115200n8\0" \
    "cpuclock=600M\0" \
    "bootargs=mem=512M a9_clk=600M clk81=187500k mac=00:01:22:65:04:88 console=ttyS0,115200n8 board_ver=v2 logo=lvds1080p,loaded,osd1\0" \
