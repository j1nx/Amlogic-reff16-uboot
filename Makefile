...
LIBS += drivers/securitkey/libsecuritykey.a
LIBS += drivers/secure/lib_secure.a
...
ifeq ($(CONFIG_M3_SECUR_BOOT),y)
M3_SEC_BOOT_TOOL_DIR = $(TOPDIR)/tools/secu_boot/
AML_ENC_TOOL = $(M3_SEC_BOOT_TOOL_DIR)encrypt_tool
M3_SEC_BOOT_RAW_CODE = $(M3_SEC_BOOT_TOOL_DIR)code_raw.bin
M3_SEC_BOOT_RSAKEY_AML = $(M3_SEC_BOOT_TOOL_DIR)rsa_key_aml.dat
M3_SEC_BOOT_RSAKEY_COMM = $(M3_SEC_BOOT_TOOL_DIR)rsa_key_comm_pub.dat
M3_SEC_BOOT_UBOOT = $(obj)u-boot-aml-ucl.bin.m3+
endif #ifeq ($(CONFIG_M3_SECUR_BOOT),y)

ifeq ($(CONFIG_COLD_HEART),y)
FIRMWARE_COLD_HEART = $(obj)firmware_cold_heart.bin
endif
...
$(obj)u-boot-aml-ucl.bin: $(PLUS_BINARY) $(FIRMWARE) $(obj)u-boot-ucl.bin
	$(obj)tools/convert --soc $(SOC)  -s $(FIRMWARE_COLD_HEART) -i $(obj)u-boot-ucl.bin -o $(@:%=%.tmp)
else
$(obj)u-boot-aml-ucl.bin: $(PLUS_BINARY) $(FIRMWARE) $(obj)u-boot-ucl.bin
...
ifeq ($(CONFIG_M3_RSAKEY_SEPARATE),y)
	@$(AML_ENC_TOOL) $@ $(M3_SEC_BOOT_UBOOT) $(M3_SEC_BOOT_RAW_CODE) $(M3_SEC_BOOT_RSAKEY_AML) $(M3_SEC_BOOT_RSAKEY_COMM)	
else  # CONFIG_M3_RSAKEY_SEPARATE
	@$(AML_ENC_TOOL) $@ $(M3_SEC_BOOT_UBOOT) $(M3_SEC_BOOT_RAW_CODE) $(M3_SEC_BOOT_RSAKEY_AML)	
endif # CONFIG_M3_RSAKEY_SEPARATE
...
#	$(MAKE) -C $(basename $(@F))/$(ARCH)/$(CPU)/$(SOC) all FIRMWARE=$@ UCL_BOOTLIBS=$(obj)lib/ucl/libucl.a
	...
	mv $(obj)tmp.bin $@
ifeq ($(CONFIG_COLD_HEART),y)
	$(obj)tools/convert --soc $(SOC)  -s $(obj)cold_heart.bin  -o $(obj)tmp.bin
	mv $(obj)tmp.bin $(obj)cold_heart.bin
	$(obj)tools/convert --soc $(SOC)  -s $(FIRMWARE) -i $(obj)cold_heart.bin -o $(FIRMWARE_COLD_HEART)
endif
...
$(obj)u-boot-aml-ucl.bin: $(PLUS_BINARY) $(FIRMWARE) $(obj)piggy.ucl
	$(obj)tools/convert --soc $(SOC)  -s $(FIRMWARE_COLD_HEART) -i $(obj)piggy.ucl -o $(@:%=%.tmp)
else
$(obj)u-boot-aml-ucl.bin: $(PLUS_BINARY) $(FIRMWARE) $(obj)piggy.ucl
...
$(obj)u-boot-aml-ucl.bin: $(FIRMWARE) $(obj)u-boot-ucl.bin
	$(obj)tools/convert --soc $(SOC)  -s $(FIRMWARE_COLD_HEART) -i $(obj)u-boot-ucl.bin -o $@
else
$(obj)u-boot-aml-ucl.bin: $(FIRMWARE) $(obj)u-boot-ucl.bin
...
$(obj)u-boot-aml.bin: $(FIRMWARE) $(obj)u-boot.bin
	...
	$(obj)tools/convert --soc $(SOC)  -s  $(obj)aml-debug-rom.old.bin -o $(obj)aml-debug-rom.bin
	$(obj)tools/convert --soc $(SOC)  -s  $(obj)usb_spl.old.bin -o $(obj)usb_spl.bin
	$(obj)tools/convert --soc $(SOC)  -s $(FIRMWARE_COLD_HEART) -i $(obj)u-boot.bin -o $@
else
$(obj)u-boot-aml.bin: $(FIRMWARE) $(obj)u-boot.bin
	mv $(obj)aml-debug-rom.bin $(obj)aml-debug-rom.old.bin
	mv $(obj)usb_spl.bin $(obj)usb_spl.old.bin
...
$(VERSION_FILE):
		@( printf '#define U_BOOT_VERSION "U-Boot %s%s(%s@trunk)"\n' "$(U_BOOT_VERSION)" \
...
test_n:
	@echo include $(wildcard $(SRCTREE)/board/amlogic/*/Readme.mk)
	@echo $(@)
	@echo $(@:_n=)
	@echo $(BOARDDIR)
	@echo $(CONFIG_PLUS_BINARY)
	@echo  PLUS_BINARY=$(shell echo $(CONFIG_PLUS_BINARY))
	@echo $(@:%=%.tmp) $@
	@echo $(@F)
