...
static int init_pctl_ddr3(struct ddr_set * ddr_setting);
	...
	#define DDR3_2Gbx16
#else
	#error "Please define DDR3 memory capacity first in file aml_tv_m2c_refe07.h!\n"
#endif
...
//trunk/include/configs/amlogic/aml_tv_m2c_refe07.h
...
static struct ddr_set __ddr_setting={
         ...
         .init_pctl=init_pctl_ddr3
                    ...
                    .t_mrd          =   4,
                    .t_1us_pck      = 94, //132 for 528MHz, 120 for 480MHz
                    .t_100ns_pck    =  9,
                    .t_init_us      = 511,
                    .t_ras          =  20,
                    .t_rc           =  27,
                    ...
                    .zqcr  = (( 1 << 24) | 0x1155),   //0x11dd->22 ohm;0x1155->0 ohm
         ...
         .init_pctl=init_pctl_ddr3  
#else
	#error "Please define DDR3 type in file aml_tv_m2c_refe07.h!\n"
#endif         
};
