...
#if 0 //def CONFIG_USB_DWC_OTG_HCD
...
#define ADD_FOR_MBX_C03
#ifdef ADD_FOR_MBX_C03
//#define POWER_KEY_LEAD_START_UP
#ifdef POWER_KEY_LEAD_START_UP
#define INPUT_KEY_VALUE ((GPIOC_bank_bit0_26(0)<<16) |GPIOC_bit_bit0_26(0))
#endif
static void set_power_pin(void) 
{  
    CLEAR_CBUS_REG_MASK(PERIPHS_PIN_MUX_4, (1<<10));	   //disable HDMI_SD4_0
    CLEAR_CBUS_REG_MASK(PERIPHS_PIN_MUX_4, (1<<1));	   //disable LCD_R0
    CLEAR_CBUS_REG_MASK(PERIPHS_PIN_MUX_3, (1<<30));	   //disable UART_TX_B
    CLEAR_CBUS_REG_MASK(PERIPHS_PIN_MUX_3, (1<<28));	   //disable I2C_SCK_B
    CLEAR_CBUS_REG_MASK(PERIPHS_PIN_MUX_3, (1<<29));	   //disable I2C_SCK_A
    CLEAR_CBUS_REG_MASK(PERIPHS_PIN_MUX_7, (1<<5));	   //disable FEC_D0_OUT
    CLEAR_CBUS_REG_MASK(PERIPHS_PIN_MUX_9, (1<<13));	   //disable I2C_SCK_A
    CLEAR_CBUS_REG_MASK(PERIPHS_PIN_MUX_10, (1<<13));	   //disable I2C_SCK_A
    
    set_gpio_mode(GPIOC_bank_bit0_26(13), GPIOC_bit_bit0_26(13), 0);
