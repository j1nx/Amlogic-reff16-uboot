...
static int init_pctl_ddr3(struct ddr_set * ddr_setting);
	...
	#define DDR3_2Gbx16
#else
	#error "Please define DDR3 memory capacity first in file aml_tv_m2c_refe09.h!\n"
#endif
...
//trunk/include/configs/amlogic/aml_tv_m2c_refe09.h
...
static struct ddr_set __ddr_setting={
         ...
         .init_pctl=init_pctl_ddr3  
#else
	#error "Please define DDR3 type in file aml_tv_m2c_refe09.h!\n"
#endif         
};
