...
static int init_pctl_ddr3(struct ddr_set * ddr_setting);
	...
	#define DDR3_2Gbx16
#else
	#error "Please define DDR3 memory capacity first in file aml_tv_m2c_2pc_4l_refe07.h!\n"
#endif
...
//trunk/include/configs/amlogic/aml_tv_m2c_2pc_4l_refe07.h
...
static struct ddr_set __ddr_setting={
         ...
         .init_pctl=init_pctl_ddr3
                    ...
                    .cl             =   7,
                    .t_faw          =  27,//20,   //8bit:20, 16bit:27
                    .t_mrd          =   4,
                    .t_1us_pck      = 132, //132 for 528MHz, 120 for 480MHz
                    .t_100ns_pck    =  14,
                    .t_init_us      = 511,
                    .t_ras          =  20,
                    .t_rc           =  27,
                    .t_rcd          =   7,
                    .t_refi_100ns   =  39,
                    .t_rfc          =  86,//59,   //4Gb:139, 2Gb:86, 1Gb:59
                    .t_rp           =   7,
                    .t_rrd          =   6,//4,   //8bit:4, 16bit:6
                    .t_rtp          =   4,
                    .t_wr           =   8,
                    .t_wtr          =   4,
                    .t_xp           =   3,//4,
                    ...
                    .zqcr  = (( 1 << 24) | 0x11cc),//0x11dd),   //0x11dd->22 ohm;0x1155->0 ohm
         .ddr_pll_cntl=0x0011022c, //0x0011022c is 528MHz   0x00110228 is 480MHz
         .ddr_clk=528,
         .ddr_ctrl= (0 << 24 ) |    //pctl_brst 4,
                    (0xff << 16) |  //reorder en for the 8 channel.
                    (0 << 15 ) |     // pctl16 mode = 0.  pctl =   32bits data pins
         ...
         .init_pctl=init_pctl_ddr3  
#else
	#error "Please define DDR3 type in file aml_tv_m2c_2pc_4l_refe07.h!\n"
#endif         
};
