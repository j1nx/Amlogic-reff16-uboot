...
void power_on_backlight(void)
{
    ...
    printf("test lcd power and backlight on\n");
    //test
    ...
    *((unsigned long*)0xC1108048) &= ~(1<<11);  //GPIOD12 lcd vcc
    *((unsigned long*)0xC110804c) &= ~(1<<11);  //GPIOD12  lcd vcc
