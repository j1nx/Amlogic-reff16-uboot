...
void power_off_VCC(int power_on)
{
    ...
    if(power_on)
	{
	    clrbits_le32(P_AO_GPIO_O_EN_N,(1<<2) | (3<<4) | (1<<6));
	    setbits_le32(P_AO_GPIO_O_EN_N,(1<<18) );		//GPIOAO_2 as VDDIO_EN
	    //setbits_le32(P_AO_GPIO_O_EN_N,(1<<22) );		//GPIOAO_6 as VCC5V_EN
	    setbits_le32(P_AO_GPIO_O_EN_N,(1<<22));			//GPIOAO_6 as VCC5V_EN
	    clrbits_le32(P_AO_GPIO_O_EN_N, (1<<21)  | (1<<20));	//GPIOAO_4,GPIOAO_5
	}
	else
	{
	    clrbits_le32(P_AO_GPIO_O_EN_N,(1<<2) | (3<<4) | (1<<6));
	    clrbits_le32(P_AO_GPIO_O_EN_N,(1<<18));			//GPIOAO_2 as VDDIO_EN
	    //clrbits_le32(P_AO_GPIO_O_EN_N,(1<<22));			//GPIOAO_6 as VCC5V_EN
	    clrbits_le32(P_AO_GPIO_O_EN_N,(1<<22) );		//GPIOAO_6 as VCC5V_EN
	    setbits_le32(P_AO_GPIO_O_EN_N, (1<<21)  | (1<<20));//GPIOAO_4,GPIOAO_5
	}
...
//	setbits_le32(P_A9_CFG2, 7<<16);
  ...
  rtc_ctrl = readl(0xC810074c);
	...
	writel(0,0xC810074c);
	// switch to 32k
  //  writel(readl(P_AO_RTI_PWR_CNTL_REG0)|(1<<8),P_AO_RTI_PWR_CNTL_REG0);//hh
    udelay(100);
