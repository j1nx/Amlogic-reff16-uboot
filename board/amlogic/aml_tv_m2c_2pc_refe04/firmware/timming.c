...
static int init_pctl_ddr3(struct ddr_set * ddr_setting);
	...
	#define DDR3_2Gbx16
#else
	#error "Please define DDR3 memory capacity first in file aml_tv_m2c_2pc_refe04.h!\n"
#endif
...
//trunk/include/configs/amlogic/aml_tv_m2c_2pc_refe04.h
...
static struct ddr_set __ddr_setting={
         ...
         .init_pctl=init_pctl_ddr3
                    ...
                    .t_mrd          =   4,
                    .t_1us_pck      = 108, //132 for 528MHz, 120 for 480MHz
                    .t_100ns_pck    =  10,
                    .t_init_us      = 511,
                    .t_ras          =  20,
                    .t_rc           =  27,
                    ...
                    .t_cke          =   3,
                    .mrs={  [0]=0,
                            [1]=(0<<9)|(0<<6)|(1<<2)| //rtt_nominal;      //(A9, A6, A2) 000 : disabled. 001 : RZQ/4   010:RZQ/2 (A6:A2)
                    ...
                    .zqcr  = (( 1 << 24) | 0x1144),//0x11dd),   //0x11dd->22 ohm;0x1155->0 ohm
         .ddr_pll_cntl=0x00110224, //0x0011022c is 528MHz   0x00110228 is 480MHz
         .ddr_clk=432,
         .ddr_ctrl= (0 << 24 ) |    //pctl_brst 4,
                    (0xff << 16) |  //reorder en for the 8 channel.
                    (0 << 15 ) |     // pctl16 mode = 0.  pctl =   32bits data pins
         ...
         .init_pctl=init_pctl_ddr3  
#else
	#error "Please define DDR3 type in file aml_tv_m2c_2pc_refe04.h!\n"
#endif         
};
