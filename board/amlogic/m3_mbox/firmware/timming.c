...
static struct ddr_set __ddr_setting={
         ...
         .init_pctl=init_pctl_ddr3
                    ...
                    .t_rcd          =   7,
                    .t_refi_100ns   =  39,
                    .t_rfc          = 86,//139,   //4Gb:139~160, 2Gb:86, 1Gb:59
                    .t_rp           =   7,
                    .t_rrd          =   4,//6,   //8bit:6 or 4, 16bit:6
                    .t_rtp          =   4,
                    .t_wr           =   8,
                    .t_wtr          =   4,
                    .t_xp           =   3,//4,
                    ...
                    .t_cke          =   3,
                    .mrs={  [0]=0,
                            [1]=(0<<6)|(1<<2)|//(1<<6)|(1<<2)| //rtt_nominal;      //(A9, A6, A2) 000 : disabled. 001 : RZQ/4   010:RZQ/2 (A6:A2)
                                (0<<5)|(0<<1)|//(0<<5)|(0<<1)| //(A5 A1),Output driver impedance control 00:RZQ/6,01:RZQ/7,10£ºRZQ/5 11:Reserved
                                (0<<12)|(0<<7),
                            [2]=0,
                            [3]=0
                        },
                    ...
                    .zqcr  = (( 1 << 24) | 0xcc),//0x11cc),   //for 0 ohm
         .ddr_pll_cntl=0x0011022c,
         .ddr_clk=528,
         .ddr_ctrl= (0 << 24 ) |    //pctl_brst 4,
                    (0xff << 16) |  //reorder en for the 8 channel.
...
={
	...
	.other_pll_cntl=0x0000087d,//750M todo
