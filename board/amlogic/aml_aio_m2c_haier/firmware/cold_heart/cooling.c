...
void cooling(void)
{
    ...
    //1V2_ON_OFF x47
    clrbits_le32(P_PREG_FGPIO_O, 1<<15);
	clrbits_le32(P_PREG_FGPIO_EN_N, 1<<15);
	//2V5_ON_OFFx46
	clrbits_le32(P_PREG_FGPIO_O, 1<<14);
	clrbits_le32(P_PREG_FGPIO_EN_N, 1<<14);
	//5V_ON_OFF b4
    clrbits_le32(P_PREG_GGPIO_O, 1<<12);
    clrbits_le32(P_PREG_GGPIO_EN_N, 1<<12);
