...
void power_off_VCC(int power_on)
{
    ...
    if(power_on)
	{
        ...
        clrbits_le32(P_AO_GPIO_O_EN_N, (1<<19)|(1<<3)); //set GPIO_AO3 to low
	}
	else
	{
        ...
        clrbits_le32(P_AO_GPIO_O_EN_N, 1<<3); //set GPIO_AO3 to high
        setbits_le32(P_AO_GPIO_O_EN_N, 1<<19); //set GPIO_AO3 to high
	}
}
#endif
