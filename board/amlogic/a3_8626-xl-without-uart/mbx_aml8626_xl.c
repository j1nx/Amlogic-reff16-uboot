...
//	return (readl(P_PREG_CGPIO_I)&(1<<22))?1:0;
    //return (readl(P_PREG_JTAG_GPIO_ADDR)&(1<<24))?1:0;//test_n
    return 0;
}
...
static void board_mmc_register(unsigned port)
{
	...
	mmc->f_min = 200000;
	mmc->f_max = 50000000;
//	clrbits_le32(P_PREG_JTAG_GPIO_ADDR,(1<<24)); //PREG_JTAG_GPIO_ADDR
//	setbits_le32(P_PREG_JTAG_GPIO_ADDR,(1<<16));//test_n
	mmc_register(mmc);
}
